...
async def check_captcha(self, ctx, increase_by=1):
    ...
    await ctx.send(
        "you have to solve this captcha first\nexample aderl, case does not matter, no spaces\nif you need help join our support server <https://discord.gg/8MdVe6NgVy>",
        file=discord.File(f"./temp/{ctx.author.id}captcha.png"),
    )
