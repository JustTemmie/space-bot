...
class rulesandstuff(commands.Cog):
    ...
    async def show_rules_command(self, ctx):
        ...
        embed.add_field(
            ...
            value="https://github.com/JustTemmie/space-bot/blob/main/rules-and-stuff/service.md\nhttps://github.com/JustTemmie/space-bot/blob/main/rules-and-stuff/privacy-policy.md\nhttps://github.com/JustTemmie/space-bot/blob/main/rules-and-stuff/rules.md",
            inline=False,
        )
