...
class ecobuild(commands.Cog):
    ...
    async def build_command(self, ctx, building = "None", amount = 0):
        ...
        if building.lower() == "lodge":
            ...
            lvl1 = f"╰ +2 skill points and a 15% chance to get a second animals from {ctx.prefix}hunt"
            lvl2 = f"╰ +2 skill points another 20% chance to get a second animal from {ctx.prefix}hunt"
            lvl3 = f"╰ +2 skill points +18 coolness from {ctx.prefix}hunt"
