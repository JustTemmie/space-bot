...
class economy(commands.Cog):
    ...
    async def slot_machine_command(self, ctx, amount = None):
        ...
        if final[0] == "<:Diamond:848602702132019210>" and final[1] == "<:Diamond:848602702132019210>" and final[2] == "<:Diamond:848602702132019210>":
            ...
            await ctx.reply(f"{ctx.author.display_name} won {20*amount} <:beaverCoin:968588341291397151>")
            ...
            await ctx.reply(f"{ctx.author.display_name} won {10*amount} <:beaverCoin:968588341291397151>")
            ...
            await ctx.reply(f"{ctx.author.display_name} won {14*amount} <:beaverCoin:968588341291397151>")
            ...
            await ctx.reply(f"{ctx.author.display_name} won {7*amount} <:beaverCoin:968588341291397151>")
            ...
            await ctx.reply(f"{ctx.author.display_name} won {6*amount} <:beaverCoin:968588341291397151>")
            ...
            await ctx.reply(f"{ctx.author.display_name} won {5*amount} <:beaverCoin:968588341291397151>")
        
        elif final[0] == final[1] or final[0] == final[2] or final[1] == final[2]:
            await self.update_bank_data(ctx.author, 0.5*amount, "wallet")
            await ctx.reply(f"{ctx.author.display_name} won {1.5*amount} <:beaverCoin:968588341291397151>")

        else:
            await self.update_bank_data(ctx.author, -1*amount, "wallet")
            await ctx.reply(f"<:sadcat:849342846582390834> - {ctx.author.display_name} lost {amount} <:beaverCoin:968588341291397151>")
