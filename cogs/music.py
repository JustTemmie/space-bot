...
class Music(commands.Cog):
    ...
    @commands.command(name="volume", brief="Sets the volume of the player")
    ...
    @commands.command(name="pause", brief="Pauses the currently playing song")
    async def _pause(self, ctx: commands.Context):
        if not ctx.voice_state.is_playing and ctx.voice_state.voice.is_playing():
            ctx.voice_state.voice.pause()
            await ctx.message.add_reaction("⏯")

    @commands.command(name="resume", brief="Resumes a currently paused song")
    ...
    @commands.command(name="stop", brief="Stops playing song and clears the queue")
